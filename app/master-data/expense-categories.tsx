...
export default function MasterDataExpenseCategoriesScreen() {
  ...
  const saveMutation = useMutation({
    mutationFn: async (dto: { name: string; description?: string }) => {
      if (editing) return expenseCategoriesService.update(editing.id, dto);
      return expenseCategoriesService.create(dto);
    },
    onSuccess: () => {
